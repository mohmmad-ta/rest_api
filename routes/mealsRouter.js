...
const {createMeal, deleteMeal, getMeal, updateMeal, getAllMyMeals, getRestaurantMeals, getAllRestaurant, resizeTourImages, uploadProductPhoto, getRestaurantSearch, getRandomRestaurants, normalizeMealBody} = require('../controllers/mealController');
